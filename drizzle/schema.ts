...
// Enum types
// roleEnum enum values: "user", "admin"
// meetingsStatusEnum enum values: "scheduled", "completed", "cancelled"
// priorityEnum enum values: "low", "medium", "high", "urgent"
// tasksStatusEnum enum values: "open", "in_progress", "completed", "blocked", "overdue"
// actionItemsStatusEnum enum values: "pending", "assigned", "completed"
// reviewTypeEnum enum values: "meeting_summary", "action_items", "email_draft", "translation"
// reviewStatusEnum enum values: "pending", "approved", "rejected", "edited"
// emailTypeEnum enum values: "reminder", "escalation", "meeting_invite", "meeting_cancellation", "status_update"
// emailStatusEnum enum values: "sent", "failed", "delivered", "opened"
// chatRoleEnum enum values: "user", "assistant"
// syncStatusEnum enum values: "active", "paused", "error"
...
export const emailLogs = mysqlTable("emailLogs", {
  ...
  sentAt: timestamp("sentAt").default(sql`CURRENT_TIMESTAMP`).notNull(),
...
export const gmailSyncState = mysqlTable("gmailSyncState", {
  ...
  syncStatus: varchar("syncStatus", { length: 50 }).default("active").notNull(),
